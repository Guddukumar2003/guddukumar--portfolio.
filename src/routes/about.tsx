...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — Rohit" },
      { name: "description", content: "Professional summary, education, and achievements of Rohit." },
      { property: "og:title", content: "About — Rohit" },
      { property: "og:description", content: "Professional summary, education, and achievements of Rohit." },

...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Guddu Kumar — Full Stack Developer & UI/UX Designer" },
      {
        name: "description",
        content:
          "Portfolio of Guddu Kumar — Full Stack Developer, UI/UX Designer & AI Enthusiast crafting premium digital experiences.",
      },
      { property: "og:title", content: "Guddu Kumar — Full Stack Developer & UI/UX Designer" },
      {
        property: "og:description",
        content: "Portfolio of Guddu Kumar — Full Stack Developer, UI/UX Designer & AI Enthusiast.",
      },
...
const services = [
  {
    ...
    desc: "Modern, performant apps built with React, Next.js and TypeScript.",
    tone: "lime",
  },
  {
    icon: Palette,
    title: "UI / UX Design",
    desc: "Clean, thoughtful interfaces backed by real product thinking.",
    tone: "sky",
  },
  {
    icon: Cpu,
    title: "AI Integrations",
    desc: "LLM-powered features, RAG pipelines and smart automations.",
    tone: "lime",
  },
  {
    icon: Layers,
    title: "Full Stack Systems",
    desc: "APIs, databases and infra designed to scale from day one.",
    tone: "sky",
  },
];
...
const featured = [
  {
    ...
    tag: "SaaS · Dashboard",
    desc: "Realtime analytics platform used by 200+ teams worldwide.",
  },
  {
    title: "Orbit AI Studio",
    tag: "AI · Design Tool",
    desc: "AI-assisted design canvas with vector generation and prompt history.",
  },
  {
    title: "Fleetly",
    tag: "Mobility · Web App",
    desc: "Fleet management suite with live tracking and driver profiles.",
  },
];
...
const testimonials = [
  {
    q: "Guddu Kumar turned our messy prototype into a beautiful, fast product. A rare mix of design taste and engineering rigor.",
    n: "Ananya S.",
    r: "Product Lead, Nova",
  },
  {
    q: "Ship quality is unreal. Every interaction felt intentional, and the codebase was a joy to inherit.",
    n: "Marcus L.",
    r: "CTO, Orbit AI",
  },
  {
    q: "Delivered ahead of schedule, communicated like a partner. Would hire again in a heartbeat.",
    n: "Priya R.",
    r: "Founder, Fleetly",
  },
];
    ...
    <>
        ...
        <div className="mx-auto grid w-full max-w-6xl items-center gap-12 lg:grid-cols-2">
          <div className="order-2 lg:order-1">
            ...
            <p className="mt-4 text-lg font-medium text-foreground/80">
              ...
              <span className="text-sky">•</span> AI Enthusiast
            </p>
            <p className="mt-5 max-w-xl text-base text-muted-foreground">
              I craft premium digital experiences — from pixel-perfect interfaces to scalable
              backends. Passionate about clean design, thoughtful motion, and shipping products that
              feel effortless.
            </p>
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <Link
                to="/projects"
                className="btn-lime group inline-flex items-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold transition hover:scale-[1.02]"
              >
                View Projects{" "}
              ...
              <a
                href="#"
                className="btn-sky inline-flex items-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold transition hover:scale-[1.02]"
              >
            ...
            <div className="mt-8 flex items-center gap-3">
              {[
                ...
                <a
                  key={i}
                  href={href}
                  className="soft-card grid h-10 w-10 place-items-center rounded-xl text-muted-foreground transition hover:-translate-y-0.5 hover:text-sky"
                >
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            sub="End-to-end product craft — from first sketch to production."
          />
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((s) => (
              <div
                key={s.title}
                className="soft-card group relative overflow-hidden rounded-3xl p-6 transition hover:-translate-y-1"
              >
                <div
                  className={`absolute -right-10 -top-10 h-32 w-32 rounded-full blur-2xl transition group-hover:scale-125 ${s.tone === "lime" ? "bg-lime/25" : "bg-sky/25"}`}
                />
                <span
                  className={`relative grid h-11 w-11 place-items-center rounded-xl ${s.tone === "lime" ? "btn-lime" : "btn-sky"}`}
                >
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
              {stats.map((s, i) => (
                <div key={s.l} className="text-center">
                  <span
                    className={`mx-auto grid h-12 w-12 place-items-center rounded-2xl ${i % 2 ? "btn-sky" : "btn-lime"}`}
                  >
                    <s.icon className="h-5 w-5" />
                  </span>
                  <div className="mt-4 text-3xl font-extrabold text-gradient sm:text-4xl">
                    {s.v}
                  </div>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex flex-wrap items-end justify-between gap-4">
            ...
            <Link
              to="/projects"
              className="group inline-flex items-center gap-1 text-sm font-semibold text-foreground hover:text-sky"
            >
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {featured.map((p, i) => (
              <div
                key={p.title}
                className="soft-card group overflow-hidden rounded-3xl transition hover:-translate-y-1"
              >
                <div
                  className={`relative h-44 overflow-hidden ${i % 2 ? "bg-gradient-brand" : "bg-[radial-gradient(circle_at_30%_20%,rgba(149,213,33,0.35),transparent_60%),radial-gradient(circle_at_70%_80%,rgba(45,158,216,0.35),transparent_60%)]"}`}
                >
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            sub="A curated stack for building fast, reliable products."
          />
          ...
          <div className="mt-8 text-center">
            <Link
              to="/skills"
              className="inline-flex items-center gap-1 text-sm font-semibold text-sky hover:text-lime"
            >
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            eyebrow="Process"
            title="How I work"
            sub="A simple, transparent flow from idea to launch."
          />
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {process.map((p, i) => (
              <div key={p.n} className="soft-card relative rounded-3xl p-6">
                <div className={`text-4xl font-black ${i % 2 ? "text-sky/30" : "text-lime/40"}`}>
                  {p.n}
                </div>
                <h3 className="mt-2 text-lg font-bold text-foreground">{p.t}</h3>
                <p className="mt-1 text-sm text-muted-foreground">{p.d}</p>
                <Zap
                  className={`absolute right-5 top-5 h-4 w-4 ${i % 2 ? "text-sky" : "text-lime"}`}
                />
              </div>
            ))}
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {testimonials.map((t, i) => (
              <div key={t.n} className="soft-card relative rounded-3xl p-6">
                <Quote
                  className={`absolute right-5 top-5 h-8 w-8 ${i % 2 ? "text-sky/30" : "text-lime/40"}`}
                />
                ...
                <div className="mt-5 flex items-center gap-3">
                  <span
                    className={`grid h-10 w-10 place-items-center rounded-full text-sm font-bold text-white ${i % 2 ? "bg-sky" : "bg-lime"}`}
                  >
                    {t.n.charAt(0)}
                  </span>
                  <div>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-5xl">
          <SectionHeader
            ...
            sub="A quick look at the roles that shaped my craft."
          />
            ...
            {[
              {
                ...
                c: "Nova Labs",
                d: "2023 — Present",
                p: "Leading a team of 4 shipping the flagship analytics product.",
              },
              {
                r: "Product Engineer",
                c: "Orbit AI",
                d: "2021 — 2023",
                p: "Built the AI canvas from prototype to 50k monthly users.",
              },
              {
                r: "Frontend Developer",
                c: "Fleetly",
                d: "2019 — 2021",
                p: "Rewrote the driver app with React and cut load time by 60%.",
              },
              {
                r: "Freelance Developer",
                c: "Independent",
                d: "2018 — 2019",
                p: "Shipped 20+ client sites across e-commerce and SaaS.",
              },
            ].map((e, i) => (
              <li key={e.c} className="relative mb-8 last:mb-0">
                <span
                  className={`absolute -left-[41px] top-1 grid h-6 w-6 place-items-center rounded-full ring-4 ring-background ${i % 2 ? "btn-sky" : "btn-lime"}`}
                >
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            ...
            title="Validated & credentialed"
            sub="Recent certifications from industry-recognized programs."
          />
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={c.t}
                className="soft-card group flex items-start gap-4 rounded-3xl p-6 transition hover:-translate-y-1"
              >
                <span
                  className={`grid h-12 w-12 shrink-0 place-items-center rounded-2xl ${i % 2 ? "btn-sky" : "btn-lime"}`}
                >
                ...
                <div className="min-w-0">
                  ...
                  <a
                    href="#"
                    className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-sky hover:text-lime"
                  >
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              {
                t: "Designing for AI-first interfaces",
                c: "Design",
                d: "Aug 12, 2026",
                r: "6 min read",
              },
              {
                t: "Scaling Next.js on the edge",
                c: "Engineering",
                d: "Jul 04, 2026",
                r: "8 min read",
              },
              {
                t: "The art of tiny microinteractions",
                c: "Craft",
                d: "Jun 18, 2026",
                r: "4 min read",
              },
              ...
              >
                <div
                  className={`h-40 ${i % 2 ? "bg-gradient-brand" : "bg-[radial-gradient(circle_at_30%_20%,rgba(45,158,216,0.35),transparent_60%),radial-gradient(circle_at_70%_80%,rgba(149,213,33,0.35),transparent_60%)]"}`}
                />
                <div className="p-6">
                  <div className="flex items-center gap-2 text-xs">
                    <span
                      className={`rounded-full px-2 py-0.5 font-semibold ${i % 2 ? "bg-sky/10 text-sky" : "bg-lime/15 text-foreground"}`}
                    >
                      {b.c}
                    </span>
                  ...
                  <h3 className="mt-3 text-lg font-bold text-foreground group-hover:text-sky">
                    {b.t}
                  </h3>
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-6xl">
          <SectionHeader
            eyebrow="Beyond Code"
            title="A few things I love"
            sub="Life outside the editor is where the best ideas come from."
          />
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: Music, t: "Music", d: "Lo-fi beats and classical piano playlists." },
              {
                icon: Camera,
                t: "Photography",
                d: "Street and travel photography on the weekends.",
              },
      ...
      <section className="px-4 py-20">
        <div className="mx-auto max-w-4xl">
          <SectionHeader
            ...
            sub="Quick answers to what most people ask before we start."
          />
          <div className="space-y-4">
            {[
              {
                q: "What kind of projects do you take on?",
                a: "Product-led websites, SaaS dashboards, AI-powered tools, and design-heavy marketing sites.",
              },
              {
                q: "How do you charge?",
                a: "Fixed-price for scoped projects, or a weekly retainer for ongoing partnerships. Estimates are always upfront.",
              },
              {
                q: "Do you work with existing teams?",
                a: "Yes — I regularly embed with product and design teams as a senior engineer or design partner.",
              },
              {
                q: "What's your typical timeline?",
                a: "Landing pages ship in 1–2 weeks, MVPs in 4–8 weeks, larger platforms in 3+ months.",
              },
              {
                q: "Do you offer post-launch support?",
                a: "Absolutely. Every project includes a 30-day warranty and optional monthly maintenance.",
              },
            ].map((f, i) => (
          ...
          <div className="soft-card relative overflow-hidden rounded-[2rem] bg-muted/40 p-10 sm:p-12">
            ...
            <div className="relative grid gap-8 md:grid-cols-2 md:items-center">
              ...
              >
                ...
                <button
                  type="submit"
                  className="btn-lime inline-flex items-center justify-center gap-2 rounded-xl px-5 py-3 text-sm font-semibold transition hover:scale-[1.02]"
                >
          ...
          <div className="soft-card relative overflow-hidden rounded-[2rem] p-10 text-center sm:p-14">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex flex-wrap justify-center gap-3">
                <Link
                  to="/contact"
                  className="btn-lime inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold transition hover:scale-[1.02]"
                >
                  Start a project <ArrowRight className="h-4 w-4" />
                </Link>
                <Link
                  to="/about"
                  className="btn-sky inline-flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold transition hover:scale-[1.02]"
                >
                  More about me
                </Link>
              </div>
